      ...
      <section className="mx-auto max-w-7xl px-5 sm:px-8 py-20">
        <div className="rounded-[2rem] border border-border/70 bg-card p-8 md:p-14 flex flex-col items-center gap-6 md:gap-8 text-center">
          ...
          <img
            ...
            loading="lazy"
            className="w-full max-w-[10rem] sm:max-w-sm h-auto dark:invert"
          />
  ...
  return (
    <div className="rounded-[2rem] border border-border/70 bg-card overflow-hidden">
      <div className="relative h-56">
        ...
        <span className="absolute top-5 left-5 pill !bg-black/80 backdrop-blur-md !text-white !border-white/20">{tag}</span>
      </div>
